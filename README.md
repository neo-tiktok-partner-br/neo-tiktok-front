...
* **Conformidade Legal Brasileira:** 4 rotas estáticas ativas (`/legal/privacidade`, `/legal/termos`, `/legal/direitos-titular`, `/legal/decreto-ecommerce`), identificando a razão social `NEOFLOW TECNOLOGIA E PERFORMANCE LTDA`, CNPJ `00.000.000/0001-00` e DPO `neo@neoflowoff.agency`.
