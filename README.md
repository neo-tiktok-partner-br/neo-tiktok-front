...
* **Conformidade Legal Brasileira:** 2 rotas estáticas ativas (`/legal/privacidade` e `/legal/termos`), identificando a razão social `Flowoff Marketing e Assessoria Digital LTDA`, CNPJ `43.376.355/0001-92` e DPO `neo@neoflowoff.agency`.
